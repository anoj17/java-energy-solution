                ...
                <div className="flex lg:flex-row flex-col lg:px-0 px-4 md:px-28 lg:space-x-9">
                    <div>
                        <div className="flex flex-col pb-10 space-y-4 border">
                            ...
                            <div className="flex flex-col space-y-4 lg:space-y-3 px-8">
                                <div className="flex flex-col lg:pb-4 justify-center items-start lg:py-2">
                                    ...
                                    <h1 className="text-black/60 text-[1rem] lg:text-[1.3rem] font-monts hover:text-yellow-500 font-bold">Crafting Dreams: Pioneer Construction Services</h1>
                                    <p className="font-ptSans text-black/60 lg:mt-3 text-[1rem]">Welcome to Pioneer Construction Services, where expertise meets ambition. Our commitment to excellence shines through in every project. From groundbreaking to finishing touches, we bring visions to life with precision and dedication. Explore the art of construction with us, where each structure tells a unique story of innovation and reliability. Join us in building a better tomorrow.</p>
                                </div>
                        ...
                        <div className="flex lg:space-x-7 space-y-4 lg:space-y-0 lg:flex-row flex-col justify-between items-center mt-10">
                            <Link href="/" className="pl-2 pr-5 flex py-2 justify-start items-start w-full hover:text-yellow-500 border-2 border-black/60 hover:border-yellow-500">
                                <div className="flex space-x-2 mx-auto justify-center items-start">
                                    <div className="pt-2">
                                        <FaLessThan size={10} />
                                    </div>
                                    <p className="text-black/60 hover:text-yellow-500">Dynamic Construction Solution: Building Tomorrow, Today</p>
                                </div>
                            </Link>
                            <Link href="/" className="pl-2 pr-5 flex justify-end items-end w-full hover:text-yellow-500 border-2 border-black/60 hover:border-yellow-500">
                                <div className="flex justify-end space-x-2 items-start py-2">
                                    <p className="text-black/60 hover:text-yellow-500">Elevate Your Vision: Stellar Innovation</p>
                                    <div className="pt-2">
