...
export default function Services() {
    return <>
        ...
        <div className="lg:py-4 py-5 lg:pb-10">
                    ...
                    <div>
                        <div className="flex flex-col pb-10 space-y-4 border">
                            <div className="relative">
                                <img src={image2.src}
                                    alt=""
                                    className='object-cover lg:h-[450px] lg:w-[750px]' />
                            ...
                            <div className="flex flex-col space-y-4 lg:space-y-3 px-8">
                                <div className="flex flex-col lg:pb-4 justify-center items-start lg:py-2">
                                    ...
                                    <h1 className="text-black/60 text-[1rem] lg:text-[1.3rem] font-monts hover:text-yellow-500 font-bold">Elevate Your Vision: Stellar Construction Innovations</h1>
                                    <p className="font-ptSans text-black/60 lg:mt-3 text-[1rem]">At Stellar Construction Innovations, we redefine the landscape of possibilities. With a blend of cutting-edge technology and skilled craftsmanship, we bring your dreams to life. From concept to completion, our commitment to quality and efficiency is unmatched. Explore a world where every structure is a testament to our passion for innovation and excellence. Join us on a journey of construction that goes beyond boundaries.</p>
                                </div>
                        ...
                        <div className="flex lg:space-x-7 space-y-4 lg:space-y-0 lg:flex-row flex-col justify-between items-center mt-10">
                            <Link href="/" className="pl-2 pr-5 flex justify-start items-start w-full hover:text-yellow-500 border-2 border-black/60 hover:border-yellow-500">
                                <div className="flex space-x-2 justify-start items-start py-2">
                                    <div className="pt-2">
                                        <FaLessThan size={10} />
                                    </div>
                                    <p className="text-black/60 hover:text-yellow-500">Crafting Dreams: Pioneer Construction Services</p>
                                </div>
                            </Link>
                            <Link href="/" className="pl-2 pr-5 flex justify-end items-end w-full hover:text-yellow-500 border-2 border-black/60 hover:border-yellow-500">
                                <div className="flex hover:text-yellow-500 justify-end items-end py-2">
                                    <p className="text-black/60 flex justify-left items-end hover:text-yellow-500">Architecting Tomorrow: Summit Construction Solution</p>
                                    <div className="pt-2">
