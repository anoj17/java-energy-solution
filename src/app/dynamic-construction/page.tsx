            ...
            <div className="w-full lg:my-10 lg:px-28">
                <div className="flex lg:flex-row flex-col lg:px-0 px-4 md:px-28 lg:space-x-9">
                    <div>
                        ...
                        <div className=" w-full flex justify-end items-end space-y-4 lgLspace-y-0 mt-10 flex-col lg:flex-row">
                            <Link href="/" className="pl-2 flex justify-end items-end pr-5 w-full lg:w-[400px] hover:text-yellow-500 border-2 border-black/60 hover:border-yellow-500">
                                <div className="flex space-x-3 justify-end items-end py-2">
